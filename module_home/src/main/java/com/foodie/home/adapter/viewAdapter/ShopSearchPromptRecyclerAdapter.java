...
import com.foodie.home.databinding.SearchPromptItemBinding;

import java.util.ArrayList;
import java.util.List;

public class ShopSearchPromptRecyclerAdapter extends RecyclerView.Adapter<ShopSearchPromptRecyclerAdapter.MyViewHolder> {

    private final ShopSearchPromptClickCallBack shopClickCallBack;
    private List<ShopSearchPrompt> searchPromptsList;
   // private Context context;
    public ShopSearchPromptRecyclerAdapter(ShopSearchPromptClickCallBack shopClickCallBack) {
...
//    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        if(searchPromptsList.size()!=0){
            holder.getBinding().setShop(searchPromptsList.get(position));
