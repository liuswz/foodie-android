...
public class RouterActivityPath {
    ...
    public static class Detail {
        ...
        /*主业务界面*/
        public static final String PRODUCTDETAIL = DETAIL +"/productDetail";
        public static final String SHOPDETAIL = DETAIL +"/shopDetail";
    }
    /**
     * 身份验证组件
     */
    ...
    public static class Login {
        ...
        /*用户详情*/
        public static final String ACTIVITYLOGIN = LOGIN + "/login";
    }
}
